    ...
    <section className="stat-v2">
      <div className="wrap">
        <Reveal as="div">
          ...
          <p className="lead">
            Skills don't add knowledge. They add the scaffolding an expert applies without thinking.
            The result is measurable — on 7B local models and on the frontier ones.
          </p>
        </Reveal>

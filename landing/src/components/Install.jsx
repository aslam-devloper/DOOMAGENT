...
export default function Install() {
  return (
    <section id="install" className="inst-v2">
      <div className="wrap">
        <Reveal as="div">
        ...
        <Reveal as="div" delay={0.1}>
          <div className="inst-v2-block">
            <div className="inst-v2-bar">
              <div className="dots"><span></span><span></span><span></span></div>
              <span>~/agents/skills/</span>
              <span className="ttl">doomagent · install</span>
            </div>
            <div>
              {installCmds.map((cmd, i) => (
                <motion.div className="inst-v2-row" key={i} custom={i} variants={stepVariants} initial="hidden" whileInView="show" viewport={{ once: true, margin: '-40px' }}>
